...
- Siradaki: deployment ortaminda Queue producer/consumer ile rate-limit binding'lerini ve dead-letter politikasini provision edip gercek servis smoke testleri; yonetilen kimlik/canli e-posta saglayicisi karari.
...
- Kimlik: Yerel gelistirmede PBKDF2 tabanli parola, HttpOnly SameSite oturum ve origin kontrolu kullanilir. Ilk hesap yalniz localhost/loopback QA isteginde kolaylik amaciyla admin olur; production public kaydi daima okuyucudur. Production'daki ilk yonetici, en az 32 karakterlik deployment sirri ve sifir mevcut admin kosuluyla Studio hostundaki tek seferlik bootstrap akisindan olusur; sonraki yoneticiler 24 saatlik tek kullanimlik davetle eklenir. Uzun pencere kotalari atomik D1 sayaciyla kesin, production ani trafik kalkani Cloudflare binding'iyle lokasyon bazli uygulanir; yonetilen kimlik saglayicisi karari production oncesinde zorunludur.
