...
- Mobil unblocker: public bolum manifestindeki responsive medya varyantlarini JSON Schema/OpenAPI/fixture'a tasimak; ardindan yonetilen kimlik ve mobil oturum stratejisini ADR ile secip production auth/session sozlesmesini ortak pakete eklemek. Iki teslim de yalniz `main` merge'i ve web/mobil kalite kapilari sonrasinda mobil tarafa commit/surum/fixture ozetiyle devredilir.
