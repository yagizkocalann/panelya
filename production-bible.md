...
- Mobil unblocker: responsive medya varyanti ortak sozlesmesi hazir; `main` merge'i ve mobil devrinden sonra yonetilen kimlik ve mobil oturum stratejisini ADR ile secip production auth/session sozlesmesini ortak pakete eklemek. Iki teslim de yalniz `main` merge'i ve web/mobil kalite kapilari sonrasinda mobil tarafa commit/surum/fixture ozetiyle devredilir.
...
- Kimlik: Yerel gelistirmede PBKDF2 tabanli parola, HttpOnly SameSite host-only oturum ve origin kontrolu kullanilir. Public ve Studio oturumlari D1'de ayrica kapsamlanir; public 2 saat, Studio 30 dakika bos kalinca sunucuda kapanir. Genel oturum kullanicinin secimine gore 1 veya 30 gunu asamaz. Rol/davet/outbox temizligi/telif karari/taslak onizleme gibi hassas Studio islemleri son 10 dakikada parola dogrulamasi ister ve basarili dogrulamada oturum tokeni yenilenir. Ilk hesap yalniz localhost/loopback QA isteginde kolaylik amaciyla admin olur; production public kaydi daima okuyucudur. Production'daki ilk yonetici, en az 32 karakterlik deployment sirri ve sifir mevcut admin kosuluyla Studio hostundaki tek seferlik bootstrap akisindan olusur; sonraki yoneticiler 24 saatlik tek kullanimlik davetle eklenir. Uzun pencere kotalari atomik D1 sayaciyla kesin, production ani trafik kalkani Cloudflare binding'iyle lokasyon bazli uygulanir; yonetilen kimlik saglayicisi karari production oncesinde zorunludur.
