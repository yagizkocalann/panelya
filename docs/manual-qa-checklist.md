...
| QA-NEW-01 | BEKLIYOR | Otomatik yeni seri penceresi | Studio `/content` + public `/`; on kosul: izole test serisi ve D1 zamanini guvenle degistirebilen yerel ortam | Studio formunda manuel `Yeni seri` secimi olmamali. Seri ilk kez yayinlaninca ana sayfada `Yeni seri` rozetiyle gorunmeli; `published_at` 29 gun onceye alindiginda kalmali, tam 30 gun onceye alindiginda kaybolmali. Arsivleyip yeniden yayinlamak ilk yayin zamanini yenilememeli. Ana sayfa 1440/1024/768/390/360 px'te tasma yapmamali; yeni seri kalmadiginda bos bolum gosterilmemeli. |
...
| QA-NAV-01 | BEKLIYOR | Ana sayfa, katalog ve yeni bolum bilgi mimarisi | Public `/`, `/catalog`, `/updates`; eski `/?view=catalog&q=ses` | Ana sayfa yalniz editorial vitrin olarak kalmali; header aramasi ve turler `/catalog`a, yeni bolum CTA'lari `/updates`a gitmeli. Eski katalog URL'si arama ve filtreleri kaybetmeden `/catalog`a yonlenmeli. Uc sayfa 1440/1024/768/390/360 px'te tasmamali, gorunur tum link ve butonlar calismali, console hata vermemeli. 2026-07-23 ajan turunda header aramasi, yeni bolum CTA'si, eski URL yonlendirmesi, uc route x bes viewport, 44 px hedefler ve bos console dogrulandi; urun sahibi gorunur akisi ayrica onaylayacak. |
| QA-CAT-01 | BEKLIYOR | Katalog arama, filtre, siralama ve cursor | `http://localhost:3000/catalog`; on kosul: en az 8 yayinlanmis seri | Metin yazarken sonuc degismemeli; Enter veya `Ara` ile ifade iceren baslik/uretici/tur aramasi uygulanmali. Tur, devam/tamamlandi ve siralama secimleri degisince mevcut arama metni korunarak otomatik uygulanmali. `Sonraki sonuclar` baglantisi dogru kalmali; sayfalar arasi seri tekrari olmamali, bozuk cursor ilk sayfaya guvenli dusmeli. 1440/1024/768/390/360 px'te form ve pagination ulasilabilir olmali. 2026-07-23 ajan turunda metin yazmanin tek basina sonuc degistirmedigi, `Ara` ile arama, tur/durum/siralama otomatik gecisleri, sorgu koruma, bes viewport, 44 px hedefler ve bos console dogrulandi; urun sahibi akisi ayrica onaylayacak. |
