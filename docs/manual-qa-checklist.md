...
| QA-DATA-01 | BEKLIYOR | Yerel QA veri paketini kurma ve sifirlama | `http://studio.localhost:3000/qa`; on kosul: yerel admin ve yakin zamanda parola dogrulamasi | Paket kuruldugunda uc sentetik okuyucu, sekiz yayinlanmis + iki durum testi serisi ve topluluk/outbox kayitlari gorunmeli; ayni islem ikinci kez kopya uretmemeli. Sifirlama yalniz QA ad alanini kaldirmali; mevcut yonetici, normal hesaplar ve ozgun katalog kayitlari korunmali. Parola, token veya hassas deger audit/loglarda gorunmemeli. 1440/1024/768/390/360 px'te form ve hizli baglantilar ulasilabilir olmali. |
...
- [ ] `QA-STU-11` Yerel QA veri paketi admin/same-origin/reauth sinirinda idempotent kurulur; sifirlama yalniz sentetik ad alanini temizler ve audit olayi uretir.
