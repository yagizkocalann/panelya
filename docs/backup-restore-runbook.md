...
Basari kosulu: verifier yesil, kanonik 19 D1 tablosu mevcut, manifestte eksik/fazla nesne yok, public katalog/seri/bolum API'leri calisiyor, Studio admin girisi yeni oturumla yapiliyor, eski oturum/token/preview/davetler kullanilamiyor ve rollback noktasi kayitli.
