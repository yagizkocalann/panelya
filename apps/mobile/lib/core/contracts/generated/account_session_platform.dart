...
/// Kaynak: `packages/contracts/schema.json` -> `$defs/AccountSessionPlatform`.
///
...
enum AccountSessionPlatform {
  ...
  static AccountSessionPlatform fromJson(String value) {
    switch (value) {
      case 'web':
        return AccountSessionPlatform.web;
      case 'android':
        return AccountSessionPlatform.android;
      case 'ios':
        return AccountSessionPlatform.ios;
      case 'unspecified':
        return AccountSessionPlatform.unspecified;
      default:
        return AccountSessionPlatform.unknown;
    }
  }

  String toJson() {
    if (this == AccountSessionPlatform.unknown) {
      throw UnsupportedError(
        'AccountSessionPlatform.unknown serialize edilemez (ham sunucu değeri tutulmuyor).',
      );
    }
    return name;
  }
