...
/// Kaynak: `packages/contracts/schema.json` -> `$defs/AccountSessionRevocationRequest`.
class AccountSessionRevocationRequest {
  const AccountSessionRevocationRequest({
    required this.scope,
  });

  factory AccountSessionRevocationRequest.fromJson(Map<String, dynamic> json) {
    final scope = json['scope'] as String;
    return AccountSessionRevocationRequest(
      scope: scope,
    );
  }

  /// Bilinen değer kümesi: "others" | "all".
  final String scope;
