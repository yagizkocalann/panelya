...
/// Kaynak: `packages/contracts/schema.json` -> `$defs/DiscoverySeriesSummary`.
class DiscoverySeriesSummary {
  const DiscoverySeriesSummary({
    required this.slug,
    required this.title,
  ...
  factory DiscoverySeriesSummary.fromJson(Map<String, dynamic> json) {
