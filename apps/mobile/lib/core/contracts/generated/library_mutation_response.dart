...
/// Kaynak: `packages/contracts/schema.json` -> `$defs/LibraryMutationResponse`.
class LibraryMutationResponse {
  const LibraryMutationResponse({
    required this.schemaVersion,
    required this.item,
  });

  factory LibraryMutationResponse.fromJson(Map<String, dynamic> json) {
