...
/// Kaynak: `packages/contracts/schema.json` -> `$defs/AccountActionCapability`.
///
...
enum AccountActionCapability {
  ...
  static AccountActionCapability fromJson(String value) {
    switch (value) {
      case 'enabled':
        return AccountActionCapability.enabled;
      case 'reauthentication_required':
        return AccountActionCapability.reauthentication_required;
      case 'provider_managed':
        return AccountActionCapability.provider_managed;
      case 'unavailable':
        return AccountActionCapability.unavailable;
      default:
        return AccountActionCapability.unknown;
    }
  }

  String toJson() {
    if (this == AccountActionCapability.unknown) {
      throw UnsupportedError(
        'AccountActionCapability.unknown serialize edilemez (ham sunucu değeri tutulmuyor).',
      );
    }
    return name;
  }
