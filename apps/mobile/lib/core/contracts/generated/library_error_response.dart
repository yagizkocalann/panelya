...
/// Kaynak: `packages/contracts/schema.json` -> `$defs/LibraryErrorResponse`.
class LibraryErrorResponse {
  const LibraryErrorResponse({
  ...
  factory LibraryErrorResponse.fromJson(Map<String, dynamic> json) {
