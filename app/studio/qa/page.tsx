...
const priorityChecks = [
  ...
  { id: "QA-CAT-01", title: "Katalog keşfi ve cursor", path: "Public /catalog", result: "Metin araması Enter/Ara ile, tür/durum/sıralama değişiklikleri otomatik uygulanmalı; mevcut arama korunmalı, cursor sayfaları tekrarsız kalmalı ve bozuk cursor güvenli biçimde ilk sayfaya dönmelidir." },
  { id: "QA-NEW-01", title: "Otomatik yeni seri penceresi", path: "Studio /content + Public /", result: "İlk public yayından sonra 30 gün görünmeli; tam 30 gün sınırında kaybolmalı, arşivleyip yeniden yayınlama süreyi sıfırlamamalı ve Studio'da manuel seçim bulunmamalıdır." },
