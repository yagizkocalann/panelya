...
export default async function StudioOutboxPage() {
  ...
  return <div className="site-shell studio-shell"><SiteHeader compact homeHref={publicHome} /><main id="main-content" className="studio-main wrap">
    <div className="studio-top"><div><p className="section-kicker">Yerel servis adaptörü</p><h1>E-posta kutusu</h1><p>Gerçek sağlayıcı bağlanana kadar doğrulama, sıfırlama ve güvenlik bildirimleri burada test edilir.</p></div><Link className="button button--ghost" href="/">← Studio</Link></div>
