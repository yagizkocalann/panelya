...
export default async function StudioPage() {
  ...
  return <div className="site-shell studio-shell"><SiteHeader compact homeHref={publicHome} />
    <main id="main-content" className="studio-main wrap">
      ...
      <aside className="studio-notice"><strong>Geliştirme modu:</strong> İlk oluşturulan yerel hesap yönetici oldu. Üretimde bu otomatik yetki kuralı kapatılacak.</aside>
      ...
      <section className="studio-roadmap"><h2>Yükleme akışı</h2><p>Kapak ve panel görselleri Studio hostunda doğrulanıp R2 depolamaya yüklenebilir; sıralama, kapak geri yükleme, süreli taslak önizleme ve responsive WebP kuyruğu hazırdır. Production öncesi yerel tarayıcı işlemcisi Cloudflare Queue/Images adaptörüne taşınacak.</p><div><Link className="button button--ghost" href="/media">Medya yükle</Link><Link className="button button--ghost" href={new URL("/production-journal", publicHome).toString()}>Üretim planını oku</Link></div></section>
    </main>
  </div>;
}
