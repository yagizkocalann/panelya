...
export default async function EditSeriesPage({ params, searchParams }: { params: Promise<{ slug: string }>; searchParams: Promise<{ error?: string; saved?: string; created?: string }> }) {
