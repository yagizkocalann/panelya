  ...
  return <div className="site-shell studio-shell"><SiteHeader compact homeHref={publicHome} />
    <main id="main-content" className="studio-main wrap">
      ...
      <section className="ad-lab-grid" aria-labelledby="ad-lab-title">
        <div><p className="section-kicker">Canlı bağlantı</p><h2 id="ad-lab-title">Google 300 × 250 test birimi</h2><p>Test yalnız localhost ve açık reklam izniyle bağlanır. Yeşil durum etiketi render sonucunu; diğer etiketler izin, ortam veya engelleyici durumunu açıklar.</p><AdSlot placement="studio-lab-01" showDisabled /></div>
