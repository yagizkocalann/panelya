...
export default function PrivacyPage() {
  return <InfoPage kicker="Veri ve gizlilik" title="Gizlilik bildirimi" intro="Bu metin lokal geliştirme sürümünde hangi verilerin tutulduğunu açıklar; production yayını öncesinde hukuki incelemeden geçirilecektir." sections={[
    ...
    { title: "Reklam testi", paragraphs: ["Google Publisher Tag'in resmî test ağı yalnız reklam izni verildiğinde ve localhost ortamında yüklenir. Yalnız gerekli seçeneğinde Google reklam alanına istek gönderilmez. Panelya publisher kimliği veya gelir hesabı kullanılmaz."] },
    { title: "Kontrolün", items: ["Gizlilik tercihin bu cihazın yerel depolamasında tutulur ve aşağıdaki düğmeyle değiştirilebilir.", "Profil bilgilerini değiştirebilirsin.", "Hesabını ve ilişkili yerel verileri silebilirsin.", "İletişim mesajının silinmesini iletişim sayfasından isteyebilirsin.", "Telif bildiriminin durumunu 90 günlük gizli bağlantıyla görebilirsin; production saklama ve silme süresi hukuki incelemeyle kesinleşecektir."] },
  ]}><div className="info-actions"><ConsentSettingsButton className="button button--ghost" /></div></InfoPage>;
}
